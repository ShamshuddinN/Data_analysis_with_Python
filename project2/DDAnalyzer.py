...
def calculate_demographic_data(print_data=True):
    ...
    average_age_men = round(df.loc[df['sex'] == 'Male', 'age'].sum()/df.loc[df['sex'] == 'Male'].shape[0], 1)
    ...
    highest_earning_country_percentage = (df.loc[df['salary'] == '>50K']['native-country'].value_counts()/df['native-country'].value_counts()).max()
    highest_earning_country = df.loc[df['salary'] == '>50K']['native-country'].value_counts() / df['native-country'].value_counts()
    highest_earning_country = highest_earning_country.loc[highest_earning_country == highest_earning_country_percentage].index[0]
